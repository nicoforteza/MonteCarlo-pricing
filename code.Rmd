---
title: "MC Pricing for Exotic Options"
...
The CEV (Constant Elasticity Variance) is a diffusion model, in this case for a stock price $S$, where r is the risk free rate, $dz$ is a wiener process, $\sigma$ is the volatility parameter and $\gamma$ is a positive constant. It takes the form $dSt = \mu Sdt + \sigma S^\gamma dz$
...
plot(strike,sensi_strike, main = "Strike Sensitivity",
...
plot(mu,sensi_mu, main = "Drift Sensitivity",
     xlab="Daily Drift", ylab="Price",)
```
...
plot(time,sensi_time, main = "Time Sensitivity",
     xlab="Time Horizon", ylab="Price",)
```
...
plot(volatility,sensi_volatility, main = "Volatility Sensitivity",
...
plot(gamma,sensi_gamma, main = "Gamma Leverage Sensitivity",
     xlab="Leverage Gamma Factor", ylab="Price",)
```
...
plot(alpha1,sensi_alpha1, main = "Lower Bound Sensitivity (Upper Bound = 1.5)",
     xlab="Lower Bound Value", ylab="Price")
```
...
plot(beta1,sensi_beta1, main = "Upper Bound Sensitivity (Lower Bound = 0.5)",
     xlab="Upper Bound Value", ylab="Price")
```
